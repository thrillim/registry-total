...
export default function SignIn() {
    return (
        <div className='h-screen w-full bg-neutral items-center p-0 flex flex-row'>
            ...
            <div className='flex-auto basis-auto w-full m-4 h-full justify-center'>
                <div className='card min-w-xs max-w-lg max-md:min-w-fit md:w-[90%] lg:w-[70%] w-[80%] bg-base-100 shadow-xl mt-[10rem] mx-auto'>
